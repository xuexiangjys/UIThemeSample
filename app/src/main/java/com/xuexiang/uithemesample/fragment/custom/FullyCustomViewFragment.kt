...
import com.xuexiang.uithemesample.databinding.FragmentFullyCustomViewBinding
 ...
 */
@Page(name = "完全自定义View")
class FullyCustomViewFragment : ViewBindingFragment<FragmentFullyCustomViewBinding>() {

    override fun viewBindingInflate(
        inflater: LayoutInflater,
        container: ViewGroup
    ) = FragmentFullyCustomViewBinding.inflate(inflater, container, false)
